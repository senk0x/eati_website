      ...
      <nav className="mx-auto max-w-7xl min-w-0 rounded-2xl bg-white px-4 py-3 sm:rounded-2xl sm:px-6 sm:py-4 md:rounded-3xl md:px-8 md:py-5">
        <div className="flex min-w-0 items-center justify-between gap-2 sm:gap-4">
          ...
          <Link
            ...
            className="block shrink-0 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#88B8FF] focus-visible:ring-offset-2"
          >
            <Image
          ...
          >
            {navLinks.map(({ href, label }) => (
              <Link
                key={href}
                href={href}
                className="text-base font-medium text-eati-ink transition-colors hover:text-[#88B8FF] md:text-lg"
              >
                {label}
              </Link>
            ))}
          ...
          <button
            ...
            className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl text-eati-ink transition-colors hover:bg-[#F0F4F8] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#88B8FF] md:hidden"
          ...
          >
            {navLinks.map(({ href, label }) => (
              <Link
                ...
                className="flex min-h-[44px] items-center rounded-xl px-4 text-base font-medium text-eati-ink transition-colors hover:bg-[#F0F4F8] hover:text-[#88B8FF]"
              >
                {label}
              </Link>
            ))}
