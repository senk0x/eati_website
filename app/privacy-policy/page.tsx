        ...
        <div className="mx-auto max-w-3xl">
          ...
          >
            <p>
              ...
              Provider&quot;) as a Freemium service. This service is intended for use &quot;AS IS&quot;.
            </p>

            <h2 className="pt-4 text-base font-semibold md:text-lg">Information Collection and Use</h2>
            <p>
            ...
            <p>
              ...
              us with certain personally identifiable information, including but not limited to Name, email, user id.
              The information that the Service Provider request will be retained by them and used as described in
              this privacy policy.
            </p>

            <h2 className="pt-4 text-base font-semibold md:text-lg">Third Party Access</h2>
            <p>
            ...
            <p>
              The Service Provider may disclose User Provided and Automatically Collected Information: as required by
              law, such as to comply with a subpoena, or similar legal process; when they believe in good faith that
              disclosure is necessary to protect their rights, protect your safety or the safety of others,
              investigate fraud, or respond to a government request; with their trusted services providers who work
              on their behalf, do not have an independent use of the information we disclose to them, and have agreed
              to adhere to the rules set forth in this privacy statement.
            </p>

            <h2 className="pt-4 text-base font-semibold md:text-lg">Use of Artificial Intelligence</h2>
            <p>
              The Application uses Artificial Intelligence (AI) technologies to enhance user experience and provide
              certain features. The AI components may process user data to deliver personalized content,
              recommendations, or automated functionalities. All AI processing is performed in accordance with this
              privacy policy and applicable laws. If you have questions about the AI features or data processing,
              please contact the Service Provider.
            </p>

            <h2 className="pt-4 text-base font-semibold md:text-lg">Opt-Out Rights</h2>
            <p>
            ...
            <h2 className="pt-4 text-base font-semibold md:text-lg">Data Retention Policy</h2>
            <p>
              ...
              via the Application, please contact them at gymboteam@gmail.com and they will respond in a reasonable
              time.
            </p>

            <h2 className="pt-4 text-base font-semibold md:text-lg">Children</h2>
            <p>
            ...
            <p>
              ...
              Service Provider discover that a child under 13 has provided personal information, the Service Provider
              will immediately delete this from their servers. If you are a parent or guardian and you are aware that
              your child has provided us with personal information, please contact the Service Provider
              (gymboteam@gmail.com) so that they will be able to take the necessary actions.
            </p>

            <h2 className="pt-4 text-base font-semibold md:text-lg">Security</h2>
            <p>
            ...
            <h2 className="pt-4 text-base font-semibold md:text-lg">Changes</h2>
            <p>
            ...
            <p>This privacy policy is effective as of 2026-01-26.</p>

            <h2 className="pt-4 text-base font-semibold md:text-lg">Your Consent</h2>
            <p>
            ...
            <h2 className="pt-4 text-base font-semibold md:text-lg">Contact Us</h2>
            <p>
              If you have any questions regarding privacy while using the Application, or have questions about the
              practices, please contact the Service Provider via email at gymboteam@gmail.com.
            </p>
          </div>
        </div>
      </main>
